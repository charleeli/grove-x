...
namespace odb
{
        ...
        mysql::statement_kind sk)
  {
    ...
    b[n].buffer_length = static_cast<unsigned long> (
      i.middle_name_value.capacity ());
    b[n].length = &i.middle_name_size;
        ...
        mysql::statement_kind sk)
  {
    ...
    //
    {
      ::boost::shared_ptr< ::std::basic_string< char > > const& v =
        o.middle_name_;
      ...
      i.middle_name_size = static_cast<unsigned long> (size);
        ...
        database* db)
  {
    ...
    //
    {
      ::boost::shared_ptr< ::std::basic_string< char > >& v =
        o.middle_name_;
