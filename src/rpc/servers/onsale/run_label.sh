...
cp ../../../depends/bin/onsale_label_server     /data/deploy/etc/onsale_server/onsale_label_server

/data/deploy/etc/onsale_server/onsale_label_server    /data/deploy/etc/onsale_server/onsale_store_server.json
