...
cp ../../../depends/bin/coupon_push_server /data/deploy/etc/coupon_server/coupon_push_server

/data/deploy/etc/coupon_server/coupon_push_server /data/deploy/etc/coupon_server/coupon_store_server.json
