...
cp ../../../depends/bin/coupon_ec_server /data/deploy/etc/coupon_server/coupon_ec_server

/data/deploy/etc/coupon_server/coupon_ec_server /data/deploy/etc/coupon_server/coupon_store_server.json
